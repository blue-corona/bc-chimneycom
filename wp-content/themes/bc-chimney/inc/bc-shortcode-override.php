...
<div class="container">
  <div class="row py-5 position-relative">
    <div class="col-12 col-lg-10 ml-lg-auto mr-lg-auto">
      ...
      <div id="bc_testimonials-swiper_<?php echo $count;?>" class="swiper-container swiper-container1">
        <div class="swiper-wrapper">
     <?php 
...
<?php }else if(get_current_blog_id() == 2){?>
  <h3 class="text-center pt-lg-4">What Our Clients Are Saying</h3>
<?php }?>

  <div class="inner-box position-relative w-75 w-sm-100 mw-100 p-4 bc_color_3  my-5 bc_color_3_bg text-center">
   <p class="p-lg-5 ml-lg-5 mr-lg-5"> <?php echo $message;?><!--  I contacted Midwest because my furnace wasn’t working. They fixed it the same day, and it didn’t cost me and arm or a leg! Fantastic company, strongly recommend! --></p>
