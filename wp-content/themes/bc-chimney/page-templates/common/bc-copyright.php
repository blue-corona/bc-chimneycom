...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class="bc_footer_copyright_bar text-center py-4 py-lg-2 bc_font_alt_3">
   ...
   <a class="bc_footer_copyright_links no_hover_underline bc_text_16" target="_blank" href="#"><img src="'.get_template_directory_uri().'/img/bc_logo.png">&nbsp;Blue Corona</a> </span>
