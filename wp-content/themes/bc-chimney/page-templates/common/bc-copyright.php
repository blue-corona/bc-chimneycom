...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class="container-fluid bc_footer_copyright_bar text-left py-md-4 py-lg-2 py-2 bc_font_alt_1 bc_line_height_24 bc_text_normal bc_text_16 ">
  ...
  <span class="d-none d-lg-inline-block d-none">&nbsp; | &nbsp;</span><a class="color_2 bc_font_alt_1 bc_line_height_24 bc_text_normal bc_text_16 no_hover_underline" href="#" data-toggle="modal" data-target="#disclaimer">Disclaimer</a>
  <span class="d-inline-block">&nbsp; | &nbsp;</span><a class="color_2 bc_font_alt_1 bc_line_height_24 bc_text_normal bc_text_16 no_hover_underline" href="#">Privacy Policy</a></p></div></div></div></div>
</div>');?>
