        ...
        <div class="row">
            <div class="col-md-9 offset-md-3 offset-lg-3 col-lg-9 col-sm-12 col-xs-12 ml-auto p-0">
                   <div class="d-flex align-items-center justify-content-end">
                        ...
                        <a href="#" class="bc_color_secondary_bg text-white px-4 py-3 bc_text_18 bc_text_semibold text-left  bc_font_alt_1 bc_color_secondary_hover_bg bc_line_height_20 border-0 w-200  no_hover_underline text-uppercase bc_color_tertiary_hover_bg outer_shadow free_estimate">
